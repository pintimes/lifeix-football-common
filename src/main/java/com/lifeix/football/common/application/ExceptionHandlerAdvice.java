...
import com.lifeix.football.common.model.Response;
...
public class ExceptionHandlerAdvice {
    ...
    /**
     * 业务逻辑异常，http code统一为200，业务code自定制
     * 
     * @param e
     */
    @ExceptionHandler(LogicException.class)
    public void handleLogicException(HttpServletResponse response, LogicException e) {
	handerException(response, HttpStatus.OK, e);
    }
	...
	try {
	    ...
	    writer.write(JSONUtils.obj2json(r));
	    writer.flush();
	    writer.close();
	} catch (Exception e) {
