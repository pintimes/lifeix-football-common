...
public class AuthorizationUtil {
    ...
    public static void adminAuthorization(String groups) {
        ...
        /**
         * 内网进入的认为是管理员，admin不通过网关传入 从前置获得header from字段，如果有值则表示是从kong过来的即不是一个Admin
         */
    ...
    /**
     * @name userAdminAuthorization @description 管理员或用户授权，groups必须包含user或者admin才能通过授权 @author
     *       xule @version 2016年8月24日 上午10:06:14 @param @return void @throws
     */
    ...
    /**
     * @name userAuthorization @description 用户授权认证 @author xule @version 2016年9月23日
     *       下午2:11:29 @param @return void @throws
     */
    ...
    /**
     * @name monitorAuthorization @description @author xule @version 2016年10月18日
     *       上午10:09:59 @param @return void @throws
     */
