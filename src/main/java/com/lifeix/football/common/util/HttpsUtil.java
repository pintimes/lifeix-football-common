...
public class HttpsUtil {
    ...
    /**
     * @name getSSLContext @description 获得SSLContext @author xule @version 2016年9月27日
     * 下午4:54:21 @param @return SSLContext @throws
     */
    ...
    /**
     * @name getResult @description 获得请求结果字符串，请求失败返回null @author xule @version 2016年9月27日
     * 下午4:54:21 @param @return SSLContext @throws
     */
    ...
    /**
     * @name getParam @description 根据post或put请求map拼接参数 @author xule @version 2016年10月21日
     * 上午11:26:46 @param @return String @throws
     */
     ...
     * @author xule
     * @version 2016年9月27日 下午4:46:13
     * @param link 请求地址，也就是url param 请求参数，用'&'拼接成字符串（应该有更好的方式，但是我还没有找到）
     * @return String 请求失败返回null
     * @throws Exception
     */
